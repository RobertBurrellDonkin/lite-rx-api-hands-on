...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier
				.create(flux)
				.expectNextMatches(userNameIs("swhite"))
				.expectNextMatches(userNameIs("jpinkman"))
				.verifyComplete();


	}

	private Predicate<User> userNameIs(String name) {
		return u -> name.equals(u.getUsername());
	}
